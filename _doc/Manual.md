...
# SNS settings      
github_username: killingbest     # modify this account to yours
weibo_username: xx      # the footer woule be auto-updated.
...
For instance, [Hello 2015])(https://killingbest.github.io/2015/01/29/hello-2015/) has the front-matter of this:
...
1. a _text style_ header like [this](https://killingbest.github.io/2019/09/08/spacemacs-workflow/) with
...
ga_domain: killingbest.github.io
```
...
- Brand new [Archive](https://killingbest.github.io/archive/) page! It combines previous Archive and Tag page and it's backward-cmpatible.
...
- Fixed [issue#15](https://github.com/killingbest/killingbest.github.io/issues/15) about code wrap.
...
<img src="http://killingbest.github.io/img/blog-md-navbar.gif" width="320" />
